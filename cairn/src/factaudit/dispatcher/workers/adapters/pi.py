...
from factaudit.dispatcher.workers.base import DriverResult, WorkerDriver
...
class PiDriver(WorkerDriver):
    ...
    def _agent_dir(worker: WorkerConfig) -> str:
        return str(PurePosixPath("/tmp/factaudit-pi") / worker.name)
    ...
    def _models_json(worker: WorkerConfig) -> str:
        ...
        payload = {"providers": {"factaudit": provider}}
