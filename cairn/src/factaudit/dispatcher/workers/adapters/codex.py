...
from factaudit.dispatcher.workers.adapters._curl import build_verbose_curl_healthcheck, expand_env, render_curl_command
from factaudit.dispatcher.workers.base import DriverResult, RegexSessionDriver
    ...
    def build_execute(self, worker: WorkerConfig, prompt: str, session: str | None) -> DriverResult:
        ...
        return DriverResult(
            argv=[
                ...
                env["CODEX_MODEL"],
                "-c",
                'model_provider="factaudit"',
                "-c",
                'model_providers.factaudit.name="factaudit"',
                "-c",
                'model_providers.factaudit.wire_api="responses"',
                "-c",
                'model_reasoning_effort="high"',
                "-c",
                f'model_providers.factaudit.base_url="{env["CODEX_BASE_URL"]}"',
                "-c",
                'model_providers.factaudit.env_key="OPENAI_API_KEY"',
                "--",
                prompt,
            ]
        )
