...
GRAPH_SNAPSHOT_ROOT = "/tmp/factaudit-prompts"
...
def project_allows_conclude_fallback(client: FactAuditClient, project_id: str, *, worker_name: str, intent_id: str) -> bool:
...
def best_effort_release_reason(client: FactAuditClient, project_id: str, worker_name: str) -> None:
...
def best_effort_release(client: FactAuditClient, project_id: str, intent_id: str, worker_name: str) -> None:
